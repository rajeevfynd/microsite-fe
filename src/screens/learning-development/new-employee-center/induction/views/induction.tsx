        ...
        <Row>
            <Col span={12}>
                <div style={{padding: '10%'}}>
                    ...
                    <p style={{margin: '10% 0'}}><h4>The entire team of JioMart is thrilled to welcome you on board. Its incredible to have such young, fresh and talented new member join our team. We hope you’ll do some amazing work here!</h4></p>
